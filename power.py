...
#%%
rho_H2 = H2.d(T=t1, p=p1) 
    #density of hydrogen at STP
rho_O2 = O2.d(T=t1, p=p1) 
    #density of oxygen at STP

mw_H2 = H2.mw(T=t1, p=p1) 
    #[kg/kmol] molecular weight of H2 at STP
mw_O2 = O2.mw(T=t1, p=p1) 
    #[kg/kmol] molecular weight of H2 at STP
...
# %%
W_H2 = cv_2*( (t3-t2)-(t4-t1) )
# %%
P_spec_H2 = W_H2*rpm/60
P_H2 = P_spec_H2*(kg_H2)
# %%
W_O2 = cv_O2_2*( (t3-t2)-(t4-t1) )
